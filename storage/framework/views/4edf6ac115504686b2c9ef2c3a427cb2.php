                              ...
                              <div class="card auth-card">
                                    <div class="card-body">
                                          <div class="p-3">
                                                ...
                                                <p class="text-muted text-center mt-4 mb-0">I already have an account <a href="<?php echo e(route('second', ['auth', 'signin'])); ?>" class="text-reset fw-bold ms-1">Sign In</a></p>
                                          </div> <!-- end col -->
                                    </div> <!-- end card-body -->
                              </div> <!-- end card -->
                       </div> <!-- end col -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', ['title' => 'Sign Up'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/auth/signup.blade.php ENDPATH**/ ?>