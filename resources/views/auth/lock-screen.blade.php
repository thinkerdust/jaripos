			...
			<div class="col-xl-5">
				<div class="card auth-card">
					<div class="card-body px-3 py-5">
						...
						<h2 class="fw-bold text-center fs-18">Hi ! {{ auth()->user()->name }}</h2>
				...
				<p class="mb-0 text-center">Not you? return <a href="{{ route('register') }}" class="text-reset fw-bold ms-1">Sign Up</a></p>
			</div> <!-- end col -->
		</div> <!-- end row -->
	</div>
</div>
