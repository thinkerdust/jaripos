...
<section class="py-20 bg-brand-600">
    <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <a href="#" class="inline-block px-10 py-4 bg-white text-brand-600 font-bold rounded-full shadow-lg hover:bg-slate-50 hover:scale-105 transition transform">
            Daftar Gratis Sekarang
        </a>
    </div>
</section>
<?php $__env->stopSection(); ?><?php /**PATH /var/www/resources/views/landing/page.blade.php ENDPATH**/ ?>