@extends('layouts.components', ['title' => 'Wizard'])
                                        ...
                                        <div class="col-12">
                                            <div class="avatar-lg mb-3">
                                                <div class="avatar-title bg-body rounded-circle border border-3 border-dashed-light position-relative">
                                                    ...
                                                    <input class="hidden" type="file" id="imageInput" accept="image/*" hidden>

                                                    <img id="preview" src="/images/users/avatar-10.jpg" alt="Preview Image" class="rounded-circle img-fluid">
                                                </div>
                                            </div>
