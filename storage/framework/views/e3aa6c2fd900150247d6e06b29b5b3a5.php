                ...
                <div class="card auth-card">
                    <div class="card-body">
                        <div class="p-3">
                            ...
                            <p class="text-muted text-center mt-4 mb-0">Don't have an account? <a href="/register" class="link-primary fst-italic text-decoration-underline fw-semibold">Sign up</a> </p>
                        </div> <!-- end col -->
                    </div> <!-- end card-body -->
                </div> <!-- end card -->
            </div> <!-- end col -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', ['title' => 'Sign In'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/auth/login.blade.php ENDPATH**/ ?>