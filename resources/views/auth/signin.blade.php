                                          ...
                                          <div class="p-3">
                                                ...
                                                <div class="p-3">
                                                       <form action="{{ route('root') }}" class="authentication-form">
                                                             ...
                                                             <div class="mb-4">
                                                                   <a href="{{ route('second', ['auth', 'password']) }}" class="float-end fw-semibold text-reset ms-1">Reset password</a>
                                                ...
                                                <p class="text-muted text-center mt-4 mb-0">Don't have an account? <a href="{{ route ('second' , ['auth','signup']) }}" class="link-primary fst-italic text-decoration-underline fw-semibold">Sign up</a> </p>
                                          </div> <!-- end col -->
                                    </div> <!-- end card-body -->
                              </div> <!-- end card -->
                       </div> <!-- end col -->
